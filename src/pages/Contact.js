    ...
    <div className='mainContact'>
      <div className='col-12 mainContactDiv'>
        ...
        <div className='col-11 m-auto'>
          <h5 className='mb-5 fw-bold fs-5 text-center'>Feel free to contact me</h5>
          <div className='row'>
            <div className='col-md-5 d-flex flex-column'>
              ...
              <div className='shadow skillsAndabout py-3 px-3 mb-5'>
                <div className=''>
                  <p><MdEmail className='me-3 fs-3 mb-1' style={{ color: '#93f9c8' }} />ihemebiriegondu@gmail</p>
                </div>
                <div>
                  <p><ImPhone className='me-3 fs-4 mb-1' style={{ color: '#93f9c8' }} />+234 705 028 6131</p>
                </div>
                <div>
                  <p><ImLocation2 className='me-3 fs-4 mb-1' style={{ color: '#93f9c8' }} />Lagos</p>
                </div>
              </div>
            </div>
